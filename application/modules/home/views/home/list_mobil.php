          ...
          <div class="row">
            ...
            <table class="table">
              <tr>
                ...
                <td><i class="fa <?= $row->parkir == 1 ? "fa-check text-success" : "fa-times text-danger" ?>"></i> Parkir & Tol</td>
                <td><i class="fa <?= $row->makanan_driver == 1 ? "fa-check text-success" : "fa-times text-danger" ?>"></i> Lunch Driver</td>
              </tr>
            </table>
          </div>
